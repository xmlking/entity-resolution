...
export class Address extends Message<Address> {
   ...
   * Apartment / Unit #
   *
   * @generated from field: optional string suite = 1;
   */
  suite?: string;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "suite", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
...
export class Member extends Message<Member> {
  ...
  /**
   * @generated from field: optional string national_id = 2;
   */
  nationalId?: string;

  /**
   * @generated from field: repeated er.schema.entity.v1.Name names = 3;
   */
  names: Name[] = [];

  /**
   * @generated from field: google.type.Date dob = 4;
   */
  dob?: Date;

  /**
   * @generated from field: er.schema.entity.v1.Gender gender = 5;
   */
  gender = Gender.UNSPECIFIED;

  /**
   * @generated from field: map<string, string> emails = 6;
   */
  emails: { [key: string]: string } = {};

  /**
   * @generated from field: map<string, string> phones = 7;
   */
   ...
   *
   * @generated from field: repeated er.schema.entity.v1.Address addresses = 8;
   */
  addresses: Address[] = [];
   ...
   *
   * @generated from field: map<string, string> identifies = 9;
   */
  identifies: { [key: string]: string } = {};
  ...
  /**
   * @generated from field: optional google.type.DateTime updated_on = 21;
   */
  updatedOn?: DateTime;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "national_id", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 3, name: "names", kind: "message", T: Name, repeated: true },
    { no: 4, name: "dob", kind: "message", T: Date },
    { no: 5, name: "gender", kind: "enum", T: proto3.getEnumType(Gender) },
    { no: 6, name: "emails", kind: "map", K: 9 /* ScalarType.STRING */, V: {kind: "scalar", T: 9 /* ScalarType.STRING */} },
    { no: 7, name: "phones", kind: "map", K: 9 /* ScalarType.STRING */, V: {kind: "scalar", T: 9 /* ScalarType.STRING */} },
    { no: 8, name: "addresses", kind: "message", T: Address, repeated: true },
    { no: 9, name: "identifies", kind: "map", K: 9 /* ScalarType.STRING */, V: {kind: "scalar", T: 9 /* ScalarType.STRING */} },
    { no: 20, name: "created_on", kind: "message", T: DateTime, opt: true },
    { no: 21, name: "updated_on", kind: "message", T: DateTime, opt: true },
  ]);
